...
const handle = {
  ...
  _getTextWidth(text) {
    ...
    let width = 0
    texts.forEach(({ fontSize, marginLeft = 0, marginRight = 0 }) => {
...
class _C extends Taro.Component {
                ...
                Taro.canvasToTempFilePath(
                  {
                    canvasId: 'canvasid',
                    success: res1 => {
                      this.triggerEvent('success', res1.tempFilePath)
                    },
                    fail: err => {
  ...
  render() {
    const { debug: debug, pxWidth: pxWidth, pxHeight: pxHeight } = this.state
    return (
      <Block>
        {/* index.wxml */}
